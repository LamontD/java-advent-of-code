...
public class PassagePathing {
    ...
    public static void main(String[] args) throws IOException {
        ...
        pathing.processAndDocumentPhase1Input("day12/tiny.txt");
        pathing.processAndDocumentPhase1Input("day12/small.txt");
        pathing.processAndDocumentPhase1Input("day12/medium.txt");
        logger.info("Part 1: Finding main problem paths...");
        pathing.processAndDocumentPhase1Input("day12/input.txt");
        logger.info("Exploring Part 2...");
        pathing.processAndDocumentPhase2Input("day12/tiny.txt");
        pathing.processAndDocumentPhase2Input("day12/small.txt");
        pathing.processAndDocumentPhase2Input("day12/medium.txt");
        logger.info("Part 2: Finding main problem paths...");
        pathing.processAndDocumentPhase2Input("day12/input.txt");
