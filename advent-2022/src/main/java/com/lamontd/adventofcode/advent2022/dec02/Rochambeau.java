...
public class Rochambeau {
    ...
    public static void main(String[] args) throws IOException {
        ...
        sampler.loadBasicPlays(new LocalResourceInput("day02/sample.txt"));
        logger.info("The part 1 sample score is: " + sampler.getGameScore());
        sampler.loadEnhancedPlays(new LocalResourceInput("day02/sample.txt"));
        ...
        realMccoy.loadBasicPlays(new LocalResourceInput("day02/input.txt"));
        logger.info("The Part 1 real score is: " + realMccoy.getGameScore());
        realMccoy.loadEnhancedPlays(new LocalResourceInput("day02/input.txt"));
